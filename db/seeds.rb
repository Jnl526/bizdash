...
Client.create(first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, company: Faker::Company.name, address: Faker::Address.street_address, city: Faker::Address.city_prefix, state: Faker::Address.state_abbr, zipcode: Faker::Address.zip_code, email:"user@domain.com", phone: Faker::PhoneNumber.phone_number, project_id: 1)
